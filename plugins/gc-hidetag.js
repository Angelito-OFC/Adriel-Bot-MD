...
/**
[ By @Karim.off || https://github.com/Karim-off/ ]
**/  
...
await conn.relayMessage(m.chat, {extendedTextMessage:{text: `${masss}\n${htextos}\n`, ...{ contextInfo: { mentionedJid: users, externalAdReply: { thumbnail: imagen1, sourceUrl: 'https://github.com/Karim-off/Adriel-Bot-MD' }}}}}, {})
}}}
handler.command = /^(hidetag|notificar|notify|aviso2)$/i
handler.group = true
handler.admin = true
